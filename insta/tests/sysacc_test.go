...
func readFromBase64(base64EncodedString string) (*insta.Instagram, error) {
	base64Bytes, err := base64.StdEncoding.DecodeString(base64EncodedString)
	if err != nil {
		return nil, err
	}
	return insta.ImportReader(bytes.NewReader(base64Bytes))
}
...
func getRandomAccount() (*insta.Instagram, error) {
