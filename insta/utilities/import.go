...
func ImportFromBytes(inputBytes []byte) (*insta.Instagram, error) {
	return insta.ImportReader(bytes.NewReader(inputBytes))
}

// ImportFromBase64String imports instagram configuration from a base64 encoded string.
//
// This function does not set proxy automatically. Use SetProxy after this call.
func ImportFromBase64String(base64String string) (*insta.Instagram, error) {
